...
const googleReviewsRow1 = [
  ...
  { name: "Angga Trians", role: "Local Guide • 2 tahun lalu", text: "Saya sudah berlangganan sangat lama, Ownernya ramah harga bersahabat , Hasil kerja cepat rapi memuaskan", rating: 5 },
  { name: "psite se", role: "2 tahun lalu", text: "Pekerjaan pak Agus ini di atas ekspektasi saya. Dan juga komunikasi nya baik sekali. Vicall via WA dengan beliau. Sangat di rekomendasi 👍👍👍", rating: 5 },
  { name: "Armin Putraabah", role: "setahun lalu", text: "Sangat membantu... lahan kosong sy jadi bersih dan pengerjaanya cukup cepat", rating: 5 },
  { name: "Suparman", role: "2 tahun lalu", text: "Hasil memuaskan bersih rapi harga bisa nego bisa melayani disemua wilayah Jakarta", rating: 5 },
...
export default function Home() {
  ...
  const handleQuotationSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const msg = `*PERMINTAAN SURAT PENAWARAN (QUOTATION) RESMI*
---------------------------------------
Nama Instansi/Perusahaan: ${quotationData.company || "-"}
Penanggung Jawab (PIC): ${quotationData.picName}
No. WA / Telp: ${quotationData.phone}
Jenis Layanan: ${quotationData.service}
Estimasi Luas / Volume: ${quotationData.areaSize || "-"}
Lokasi Pekerjaan: ${quotationData.address}
---------------------------------------
Mohon untuk dapat diterbitkan Surat Penawaran Resmi dari PT TEBAS RUMPUT SAPUTRA. Terima kasih.`;
  ...
  return (
    <div className="min-h-screen font-sans selection:bg-primary/20 selection:text-primary overflow-x-hidden">
      ...
      <main>
            ...
            >
              ...
              <motion.div variants={fadeIn} className="flex flex-col sm:flex-row gap-4 items-center w-full lg:w-auto">
                <button
                  ...
                  className="group btn-primary w-full sm:w-auto text-base px-10 py-5 flex items-center justify-center gap-3 shadow-2xl shadow-primary/30 hover:scale-[1.02] transition-all"
                >
                ...
                <button
                  ...
                  className="w-full sm:w-auto text-base px-8 py-5 flex items-center justify-center gap-2 bg-slate-100 text-slate-800 font-bold rounded-2xl border border-slate-200 hover:bg-slate-200 transition-all cursor-pointer"
                >
              ...
              <motion.div variants={fadeIn} className="pt-6 border-t border-slate-100 w-full grid grid-cols-2 sm:grid-cols-4 gap-3 text-center sm:text-left">
                <div className="flex flex-col sm:flex-row items-center gap-2">
                  <div className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center text-primary shrink-0">
                    <Award className="w-4 h-4" />
                  </div>
                  <div>
                    <h5 className="text-xs font-black text-slate-900 leading-none">Pengalaman 5+ Tahun</h5>
                    <p className="text-[10px] text-slate-400 font-medium mt-0.5">Tenaga Profesional</p>
                  </div>
                </div>
                <div className="flex flex-col sm:flex-row items-center gap-2">
                  <div className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center text-primary shrink-0">
                  ...
                  <div>
                    <h5 className="text-xs font-black text-slate-900 leading-none">Garansi 100%</h5>
                    <p className="text-[10px] text-slate-400 font-medium mt-0.5">Clean-Up Rapi</p>
                  </div>
                </div>
                <div className="flex flex-col sm:flex-row items-center gap-2">
                  <div className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center text-primary shrink-0">
                  ...
                  <div>
                    <h5 className="text-xs font-black text-slate-900 leading-none">PT Resmi</h5>
                    <p className="text-[10px] text-slate-400 font-medium mt-0.5">SK Kemenkumham</p>
                  </div>
                </div>
                <div className="flex flex-col sm:flex-row items-center gap-2">
                  <div className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center text-primary shrink-0">
                  ...
                  <div>
                    <h5 className="text-xs font-black text-slate-900 leading-none">Harga Transparan</h5>
                    <p className="text-[10px] text-slate-400 font-medium mt-0.5">Tanpa Biaya Tersembunyi</p>
                  </div>
                </div>
              </motion.div>
            </motion.div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-4 gap-8 relative">
              ...
              {[
                ...
                { icon: <CheckCircle2 />, title: "Pelunasan & Selesai", desc: "Inspeksi hasil pengerjaan. Pelunasan dilakukan setelah Anda menyetujui (approve) pengerjaan sudah sesuai." }
              ].map((step, i) => (
                <motion.div 
                  key={i}
                  initial={{ opacity: 0, y: 20 }}
        ...
        <section id="keunggulan" className="section-padding bg-slate-50">
          <div className="max-w-4xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="space-y-12">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {[
                  { title: "Pengalaman 5+ Tahun", desc: "Didukung tim & tenaga kerja profesional berpengalaman lebih dari 5 tahun di bidangnya." },
                  { title: "Respon Cepat", desc: "Admin sigap membalas dan tim siap melayani pengerjaan panggilan." },
                  { title: "Alat Lengkap", desc: "Menggunakan peralatan & mesin modern untuk hasil yang rapi dan presisi." }
                ].map((item, i) => (
              ...
              {/* Dedicated Guarantee Banner */}
              <div className="bg-gradient-to-r from-slate-900 to-slate-800 text-white p-8 rounded-[2rem] shadow-xl flex flex-col md:flex-row items-center justify-between gap-6 border border-slate-700">
                <div className="flex items-center gap-5">
                  <div className="w-14 h-14 rounded-2xl bg-primary/20 text-primary flex items-center justify-center shrink-0 border border-primary/30">
                    <ShieldCheck className="w-8 h-8" />
                  </div>
                  <div className="space-y-1">
                    <h4 className="text-lg font-black text-white">Komitmen Garansi Layanan 100%</h4>
                    <p className="text-xs text-slate-300 font-medium max-w-xl">
                      Hasil pengerjaan potong rumput atau tebang pohon dipastikan rapi dan seluruh sisa sampah lahan dibersihkan. Jika belum sesuai, tim kami siap merapikan kembali.
                    </p>
                  </div>
                </div>
                <button 
                  onClick={() => setActiveModal("quotation")}
                  className="px-6 py-3.5 bg-primary text-white text-xs font-black rounded-xl hover:bg-primary-dark transition-all shrink-0 flex items-center gap-2 shadow-lg"
                >
                  <FileText className="w-4 h-4" /> Minta Penawaran Resmi
                </button>
              </div>
            </motion.div>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[
                    { number: "5+ Tahun", label: "Pengalaman Layanan", desc: "Tenaga profesional berpengalaman luas di Jakarta" },
                    { number: "350+", label: "Halaman Dirapikan", desc: "Ratusan proyek selesai dengan rapi & bersih" },
                    { number: "60+", label: "Ulasan Google", desc: "Ulasan positif dari warga Jakarta di Google Maps" },
        ...
        <section id="testimoni" className="py-14 bg-slate-50 overflow-hidden">
          <div className="max-w-7xl mx-auto px-6 mb-8 text-center">
             <h2 className="text-xs font-bold text-primary tracking-[0.2em] uppercase mb-2">Ulasan Google Maps</h2>
          ...
          <div className="space-y-4">
            ...
            <div className="flex w-fit animate-marquee hover:[animation-play-state:paused] gap-4">
              {[...googleReviewsRow1, ...googleReviewsRow1, ...googleReviewsRow1].map((t, i) => (
                <div key={i} className="w-[240px] md:w-[280px] bg-white p-4 rounded-2xl border border-slate-100 shadow-sm flex flex-col justify-between gap-3 shrink-0">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-0.5 text-amber-400">
                      {[...Array(t.rating)].map((_, idx) => <Star key={idx} className="w-3.5 h-3.5 fill-current" />)}
                    </div>
                    <svg className="w-4 h-4 text-slate-300" viewBox="0 0 24 24" fill="currentColor"><path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285F4"/><path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"/><path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" fill="#FBBC05"/><path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#EA4335"/></svg>
                  </div>
                  <p className="text-slate-600 text-xs leading-relaxed font-medium line-clamp-3">"{t.text}"</p>
                  <div className="flex items-center gap-2.5 pt-2 border-t border-slate-100">
                    ...
                    <div className="truncate">
                      <h4 className="text-slate-900 font-bold text-xs truncate">{t.name}</h4>
                      <p className="text-slate-400 text-[10px] truncate">{t.role}</p>
                    </div>
                  </div>
                </div>
              ))}
            ...
            {/* Marquee Row 2 (Gerak ke Kanan / Berlawanan Arah) */}
            <div className="flex w-fit animate-marquee-reverse hover:[animation-play-state:paused] gap-4">
              {[...googleReviewsRow2, ...googleReviewsRow2, ...googleReviewsRow2].map((t, i) => (
                <div key={i} className="w-[240px] md:w-[280px] bg-white p-4 rounded-2xl border border-slate-100 shadow-sm flex flex-col justify-between gap-3 shrink-0">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-0.5 text-amber-400">
                      {[...Array(t.rating)].map((_, idx) => <Star key={idx} className="w-3.5 h-3.5 fill-current" />)}
        ...
        {activeModal && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-6">
            ...
            {activeModal === "quotation" ? (
              <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }} className="relative bg-white w-full max-w-xl p-6 sm:p-8 rounded-[2.5rem] overflow-y-auto max-h-[90vh] shadow-2xl">
                <button onClick={() => setActiveModal(null)} className="absolute top-6 right-6 p-2.5 rounded-full bg-slate-100 hover:bg-slate-200 transition-colors"><X className="w-5 h-5 text-slate-600" /></button>
                ...
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    <h2 className="text-xl sm:text-2xl font-black text-slate-900 tracking-tight">Minta Penawaran Resmi</h2>
                    <p className="text-xs text-slate-500 font-semibold">PT TEBAS RUMPUT SAPUTRA</p>
                  </div>
                </div>

                <p className="text-slate-500 text-xs mb-6 font-medium leading-relaxed">
                  Isi formulir di bawah ini untuk menerbitkan **Surat Penawaran (Quotation)** resmi berstempel perusahaan untuk instansi, kantor, atau perorangan.
                </p>

                <form onSubmit={handleQuotationSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Instansi / Perusahaan</label>
                      <input
                        type="text"
                        placeholder="Contoh: PT Maju Bersama / Perorangan"
                    ...
                    <div className="space-y-1.5">
                      <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Penanggung Jawab (PIC) *</label>
                      <input
                        type="text"
                        placeholder="Contoh: Bpk. Hendra"
                        className="w-full px-4 py-3 rounded-xl border border-slate-100 bg-slate-50 focus:bg-white focus:border-primary outline-none transition-all text-xs font-medium"
                        value={quotationData.picName}
                        onChange={(e) => setQuotationData({ ...quotationData, picName: e.target.value })}
                        required
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <select
                        ...
                        onChange={(e) => setQuotationData({ ...quotationData, service: e.target.value })}
                        required
                      >
                        <option value="Potong Rumput">Potong Rumput</option>
                        <option value="Tebang Pohon">Tebang Pohon</option>
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Alamat Lokasi Pekerjaan *</label>
                    <textarea
                      rows={2}
                      placeholder="Contoh: Jl. Sudirman No.45, Kebayoran Baru, Jakarta Selatan"
                      className="w-full px-4 py-3 rounded-xl border border-slate-100 bg-slate-50 focus:bg-white focus:border-primary outline-none transition-all text-xs font-medium"
                  ...
                  <button
                    type="submit"
                    className="w-full bg-slate-900 text-white py-4 rounded-xl font-black text-sm shadow-xl hover:bg-black transition-all flex items-center justify-center gap-2 mt-2 cursor-pointer"
                  >
                    <Send className="w-4 h-4 text-primary" /> Kirim & Terbitkan Surat Penawaran
                  </button>
                </form>
              </motion.div>
            ) : (
                ...
                <div className="text-slate-600 space-y-4 text-sm leading-relaxed font-medium">
                  {activeModal === 'terms' ? (
                    <>
                      ...
                      <p>2. Pelunasan pembayaran dilakukan setelah klien menyetujui (approve) hasil pekerjaan bahwa seluruh pengerjaan telah sesuai dan rapi.</p>
      ...
      {/* Dual Floating Action Buttons (WA + Direct Call) */}
      <div className="fixed bottom-6 right-6 z-[90] flex flex-col items-end gap-3">
        <div className="hidden md:flex bg-slate-900 text-white px-4 py-2 rounded-2xl shadow-2xl text-xs font-bold items-center gap-2 border border-slate-700 animate-pulse">
          <span className="w-2.5 h-2.5 rounded-full bg-green-400 animate-ping"></span>
          <span>Respon Cepat 24/7 • Chat WA & Telepon Direct</span>
        </div>

        <div className="flex items-center gap-3">
          {/* Direct Phone Call Button */}
          <a
            href="tel:089502470657"
            className="w-14 h-14 bg-slate-900 text-white rounded-full shadow-[0_10px_30px_rgba(15,23,42,0.4)] flex items-center justify-center hover:scale-110 hover:bg-black transition-all border border-slate-700 group relative"
            title="Telepon Langsung"
          >
            <PhoneCall className="w-6 h-6 text-blue-400 group-hover:rotate-12 transition-transform" />
            <span className="absolute -top-8 right-0 bg-slate-900 text-white text-[9px] font-black px-2.5 py-1 rounded-md shadow-md opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
              Telepon Direct
            </span>
          </a>
          ...
          <button
            onClick={handleBooking}
            className="w-16 h-16 bg-[#25D366] text-white rounded-full shadow-[0_20px_50px_rgba(37,211,102,0.4)] flex items-center justify-center hover:scale-110 transition-transform relative group"
            title="Chat WhatsApp"
          >
